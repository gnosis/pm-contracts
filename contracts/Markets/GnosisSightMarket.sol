...
contract GnosisSightMarketData {
    /*
     *  Constants
     */
...
contract GnosisSightMarketProxy is Proxy, MarketData, GnosisSightMarketData {
...
contract GnosisSightMarket is Proxied, Market, GnosisSightMarketData {
    using SafeMath for *;
    ...
    modifier isWhitelisted() {
        require(whitelist.isWhitelisted(msg.sender) == true, 'User must be whiteliisted to participate');
        _;
    }
