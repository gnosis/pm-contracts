...
contract('event', function (accounts) {
    ...
    it('should buy and verify outcomes', async () => {
        ...
        // var outcomeTokensArray = [outcomeToken1, outcomeToken2]
        // assert.deepEqual(await event.getOutcomeTokens(), outcomeTokensArray)
        // assert.deepEqual(await event.getOutcomeTokenDistribution(accounts[buyer]),
